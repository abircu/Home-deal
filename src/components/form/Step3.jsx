                ...
                <div>
                    ...
                    <div className="form-row">
                        <div className="form-group col-12 col-sm-8 col-md-7 col-md-offset-5 col-sm-offset-4">
                            ...
                            <p className="sd-m-0">
                                Onze vakmannen nemen vaak eerst telefonisch
                                contact op om je een offerte op maat te kunnen
                                sturen. Dit is vrijblijvend.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        <div className="form-group col-11 col-md-7">
                            ...
                            <p className="form-help-text sd-mt-0_5 sd-mb-0">
                                Uw telefoonnummer wordt uitsluitend gedeeld met
                                geschikte vakmensen. We bellen u of sturen een
                                sms-bericht om uw telefoonnummer te verifiëren.
                            </p>
                            {formErrors.phone_number &&
                                touched.phone_number && (
                                    <div className="text-danger">
                    ...
                    >
                        <div className="form-group col-11 col-md-7">
                            ...
                            <p className="form-help-text sd-mt-0_5 sd-mb-0">
                                Vakmensen zullen hun offertes naar dit
                                e-mailadres sturen
                            </p>
