...
const Step2 = ({ step, setStep, setFormData }) => {
  ...
  const [constructionDrawingAvailable, setConstructionDrawingAvailable] =
    useState("");
  ...
  const handleConstructionDrawingAvailableChange = (e) =>
    setConstructionDrawingAvailable(e.target.value);
  ...
  const handleSubmit = () => {
    ...
    if (categoryIndex && typeIndex && projectDescription) {
      setFormData((prev) => ({
        ...
        permitType,
        permitAvailable,
        constructionDrawingAvailable,
        materialAvailable,
        executionDate,
        buyerIntention,
        buyingIntentionDecisions,
        addPhoto,
        projectDate,
        demolition,
      }));
  ...
  const getCategoryError = () =>
    submitted && !categoryIndex
      ? "Kies a.u.b. een van bovenstaande opties"
      : "";
  const getTypeError = () =>
    submitted && !typeIndex ? "Kies a.u.b. een van bovenstaande opties" : "";
  const getYearError = () => {
  ...
  const getDemolitionTypeError = () =>
    submitted && !demolitionType
      ? "Kies alstublieft één van de mogelijkheden"
      : "";
  const getPermitTypeError = () =>
    submitted && !permitType ? "Kies alstublieft één van de mogelijkheden" : "";
  const getPermitAvailableError = () =>
    submitted && !permitAvailable
      ? "Kies alstublieft één van de mogelijkheden"
      : "";
  const getConstructionDrawingAvailableError = () => {
    ...
    return submitted && !constructionDrawingAvailable
      ? "Kies alstublieft één van de mogelijkheden"
      : "";
  };
  const getMaterialAvailableError = () =>
    submitted && !materialAvailable
      ? "Kies alstublieft één van de mogelijkheden"
      : "";

  const getExecutionDateError = () =>
    submitted && !executionDate ? "Dit veld is verplicht" : "";
  const getAddPhotoError = () =>
    submitted && !addPhoto ? "Dit veld is verplicht" : "";
  const getProjectDescriptionError = () =>
    submitted && !projectDescription.length ? "Dit veld is verplicht" : "";

  const getBuyerIntentionError = () =>
    submitted && !buyerIntention ? "Dit veld is verplicht" : "";

  const categoryOptions = [
    {
      id: "contractors",
      value: "contractors",
      label: "Verbouwen en renoveren",
    },
  ...
  const typeOptions = [
    {
      id: "house_expansion_installation",
      value: "house_expansion_installation",
      label: "Aanbouw plaatsen",
    },
    {
      id: "building_house",
      value: "building_house",
      label: "Nieuw huis bouwen",
    },
    {
      id: "attic_renovation",
    ...
    {
      id: "garage_renovation",
      value: "garage_renovation",
      label: "Garage verbouwen",
    },
    {
      id: "cellar_renovation",
      value: "cellar_renovation",
      label: "Kelder verbouwen",
    },
    {
      id: "new_storey_installation",
      value: "new_storey_installation",
      label: "Opbouw plaatsen",
    },
    {
      id: "renovation_general",
      value: "renovation_general",
      label: "Verbouwen en renoveren - algemeen",
    },
  ];
  ...
  const typeOptionsPlumber = [
    {
      id: "bathroom_installation_renovation",
      value: "bathroom_installation_renovation",
      label: "Badkamer plaatsen of verbouwen",
    },
    {
      id: "toilet_renovation",
      value: "toilet_renovation",
      label: "Toilet verbouwen",
    },
  ];
  ...
  const buyerIntentionOptions = [
    {
      id: "yes134",
      value: "yes",
      label: "Ja, na het vergelijken van de vakmensen",
    },
    {
      id: "unknown2",
      value: "unknown",
      label: "Ik weet het nog niet, afhankelijk van de informatie",
    },
    {
      id: "no645",
      value: "no",
      label: "Nee, ik ben alleen op zoek naar informatie",
    },
  ];
    ...
    <fieldset disabled={step !== 2}>
      {step === 2 && (
        <div>
          <div
            className={`form-row ${
              submitted && !categoryIndex ? "sd-form-row-invalid" : ""
            }`}
          >
          ...
          {categoryIndex === "contractors" && (
            <div
              className={`form-row ${
                submitted && !typeIndex ? "sd-form-row-invalid" : ""
              }`}
            >
              <div className="form-group col-11 col-md-7">
          ...
          {categoryIndex === "contractors" &&
            typeIndex !== "building_house" &&
            typeIndex !== "house_expansion_installation" && (
              <div
                className={`form-row ${
                  submitted &&
                  categoryIndex === "contractors" &&
          ...
          {categoryIndex === "contractors" &&
            (typeIndex === "building_house" ||
              ...
              <div
                className={`form-row ${
                  submitted && !permitType ? "sd-form-row-invalid" : ""
                }`}
              >
                <div className="form-group col-11 col-md-7">
          ...
          {categoryIndex === "contractors" && permitType === "yes" && (
            <div
              className={`form-row ${
                submitted && !permitAvailable ? "sd-form-row-invalid" : ""
              }`}
            >
              <div className="form-group col-11 col-md-7">
                <label htmlFor="permitAvailable">
          ...
          {categoryIndex === "contractors" && (
            <div
              className={`form-row ${
                submitted && !constructionDrawingAvailable
                  ? "sd-form-row-invalid"
                  : ""
              }`}
            >
              <div className="form-group col-11 col-md-7">
                <label htmlFor="constructionDrawingAvailable">
          ...
          {!(
            ...
            categoryIndex === "contractors" && (
              <div
                className={`form-row ${
                  submitted && !materialAvailable ? "sd-form-row-invalid" : ""
                }`}
              >
                <div className="form-group col-11 col-md-7">
                  <label htmlFor="materialAvailable">
          ...
          {(categoryIndex === "contractors" ||
            ...
            <div
              className={`form-row ${
                submitted && !executionDate ? "sd-form-row-invalid" : ""
              }`}
            >
              <div className="form-group col-11 col-md-7">
          ...
          {(categoryIndex === "contractors" ||
            ...
            <div
              className={`form-row ${
                submitted && !buyerIntention ? "sd-form-row-invalid" : ""
              }`}
            >
              <div className="form-group col-11 col-md-7">
                <label htmlFor="buyerIntention">
          ...
          {buyerIntention === "unknown" && (
            <div className="form-row">
              <div className="form-group col-11 col-md-7">
                <label htmlFor="buyingIntentionDecisions">
                  ...
                  <div className="sd-checkbox-row">
                    <div className="custom-control custom-checkbox">
                      <input
                        ...
                        name="buyingIntentionDecisions"
                        value="availability"
                        checked={buyingIntentionDecisions.includes(
                          "availability"
                        )}
                        onChange={handleBuyingIntentionDecisionsChange}
                      />
          ...
          <div
            className={`form-row ${
              submitted && !projectDescription.length
                ? "sd-form-row-invalid"
                : ""
            }`}
          >
            <div className="form-group col-md-12">
              ...
              <p className="form-help-text">
                Beschrijf in het kort uw project en ontvang specifiekere
                offertes
              </p>
              <div>
                <textarea
          ...
          <div className="form-row">
            <div className="col-md-7">
              <button
                type="button"
                className="btn btn-arrow btn-primary bg-warning w-100"
