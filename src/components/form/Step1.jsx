                ...
                {touched.postcode && (
                  <span
                    className={`input-icon ${
                      formErrors?.postcode ? "icon-invalid" : "icon-valid"
                    }`}
                  ></span>
                )}
              </div>
            ...
            <div className="form-group col-11 col-md-7">
              <div className="position-relative input-text">
                ...
                {touched.city && (
                  <span
                    className={`input-icon ${
                      formErrors.city ? "icon-invalid" : "icon-valid"
                    }`}
                  ></span>
                )}
              </div>
            ...
            <div className="form-group col-11 col-md-7">
              <div className="position-relative input-text">
                ...
                {touched.address && (
                  <span
                    className={`input-icon ${
                      formErrors.address ? "icon-invalid" : "icon-valid"
                    }`}
                  ></span>
                )}
              </div>
            ...
            <div className="form-group col-11 col-md-7">
              <div className="position-relative input-text">
                ...
                {touched.address_number && (
                  <span
                    className={`input-icon ${
                      formErrors.address_number ? "icon-invalid" : "icon-valid"
                    }`}
                  ></span>
                )}
              </div>
              {formErrors.address_number && touched.address_number && (
                <div className="text-danger">
                  <div
                    className="sd-mt-0_5 p-small"
                    style={{ display: "inline" }}
